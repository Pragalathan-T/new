...
import { BookOpen, ArrowRight, Shield, BarChart3, Clock, CheckCircle, Users, Award } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive features designed to make online examination simple, secure, and effective.
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of educators and students who trust our platform for online examinations.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-400 mb-6">
                The modern solution for online examinations. Secure, reliable, and user-friendly.
              </p>
            </div>
            <div>
